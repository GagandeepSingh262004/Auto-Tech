            ...
            <div className="flex justify-center">
              <table className="table-fixed w-full border-collapse border border-gray-300 shadow-lg">
                ...
                <tbody style={{ fontFamily: "Montserrat" }}>
                  ...
                  <tr>
                    <td className="border p-4 font-semibold">Brand</td>
                    <td className="border p-4">{carData.brand}</td>
                  </tr>
                  <tr>
                    <td className="border p-4 font-semibold">Model</td>
                    <td className="border p-4">{carData.model}</td>
                  </tr>
                  <tr>

              ...
              <div className="flex flex-col gap-4 w-full">
                <table className="table-fixed w-full border-collapse border border-gray-300 shadow-lg">
                  <tbody style={{ fontFamily: "Montserrat" }}>
                    ...
                    {type === "Rent" && (
                      <tr>
                        <td className="border p-4 font-semibold">Rent Price</td>
                        <td className="border p-4">
                          <div className="flex flex-col md:flex-row md:items-center n gap-2">
                            <div className="flex items-center text-green-600 text-2xl font-bold">
                              <div>₹{prices.originalPrice.toFixed(2)}</div>
                    ...
                    {carData.onDiscountSale && (
                      <tr>
                        <td className="border p-4 font-semibold">Discount</td>
                        <td className="border p-4">
                          <div className="flex flex-col justify-start md:flex-row md:items-center gap-2 md:gap-4 lg:gap-8">
                            ...
                            <div className="bg-blue-500 text-white font-semibold px-4 py-2 rounded inline-block">
                              {carData.onDiscountSale.discountPercentage}% Off
                            </div>
                          </div>
                        </td>
                      </tr>
                    )}
                    {type === "Buy" && carData.onDiscountSale && (
                      <tr>
                        ...
                        <td className="border p-4">
                          <div className="flex flex-col md:flex-row md:items-center n gap-2">
                            <div className="text-green-600 text-2xl font-bold">
                              ₹{prices.priceAfterDiscount.toFixed(2)}
                            </div>
                          </div>
                        </td>
                      </tr>
                    )}
                    {type === "Rent" && carData.onDiscountSale && (
                      <tr>
                        <td className="border p-4 font-semibold">
                        ...
                        <td className="border p-4">
                          <div className="flex flex-col md:flex-row md:items-center n gap-2">
                            <div className="flex items-center text-green-600 text-2xl font-bold">
                              <div>₹{prices.priceAfterDiscount.toFixed(2)}</div>
                              <div className="text-sm text-gray-600 ml-2">
                                {"Per Day"}
                              </div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td className="border p-4">
                            <div className="flex flex-col md:flex-row md:items-center n gap-2">
                              <div className="flex items-center text-green-600 text-2xl font-bold">
                                <div>
                                  {`$${prices.finalPriceForRent.toFixed(2)}`}
                                </div>
                              </div>
                            </div>
                          </td>
                      ...
                      {type === "Rent" && (
                        <td className="border p-4">
                          ...
                          >
                            ₹
                            {(
                              prices.finalPriceForRent + prices.commission
                            ).toFixed(2)}
                          </div>
                        </td>
                      )}
              ...
              <table className="table-fixed w-full border-collapse border border-gray-300 shadow-lg">
                ...
                >
                  <tr className="bg-black text-white">
                    <th className="p-4 w-1/2 md:w-1/4 text-left">Attribute</th>
                ...
                <tbody style={{ fontFamily: "Montserrat" }}>
                          ...
                          <div className="flex flex-col md:flex-row md:items-center n gap-2">
                            <div className="text-green-600 text-2xl font-bold">
                              ...
                              {(
                                carData.price *
                                (1 -
                                  carData.onDiscountSale.discountPercentage /
                                    100)
                              ).toFixed(2)}
                            </div>
                  ...
                  <tr>
                    <td className="border p-4 font-semibold">Year</td>
                    <td className="border p-4">{carData.year}</td>
                  </tr>
                  <tr>
                    <td className="border p-4 font-semibold">Fuel Type</td>
                    <td className="border p-4">{carData.fuelType}</td>
                  </tr>
                  <tr>
                    <td className="border p-4 font-semibold">Mileage</td>
                    <td className="border p-4">{carData.mileage} km/l</td>
                  </tr>
                  <tr>
                    <td className="border p-4 font-semibold">Transmission</td>
                    <td className="border p-4">{carData.transmission}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="border p-4 font-semibold">Date Listed</td>
                    <td className="border p-4">
                      {new Date(carData.dateListed).toLocaleDateString()}
                    </td>
                  </tr>
                  <tr>
                    <td className="border p-4 font-semibold">Seller</td>
                    <td className="border p-4">
                      {carData.owner.name}

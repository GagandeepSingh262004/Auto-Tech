      ...
      if (key === "location") {
        ...
        if (key === "isAvailableForRent" || key === "rentPrice") {
          ...
          if (formData.rentPrice > 5000) {
            alert("Rent Price should be less than Equal to 5000 Per Day");
            return;
          }
          ...
          <div className="flex flex-col gap-4">
            ...
            {id && (
              <p className="text-red-500 text-center p-4 font-bold">
                Note: Uploading a new image will replace the existing image. If
                you don't want to change the image, leave this field empty.
              </p>
            )}
            {formData.image && (
              <button
            ...
            {formData.imageError && (
              <p className="text-red-500 mt-2">{formData.imageError}</p>
            )}
                  ...
                  <tr>
                    ...
                    <td className="border p-4">
                      <select
                        ...
                        value={formData.isAvailableForSale ? "true" : "false"}
                  ...
                  <tr>
                    ...
                    <td className="border p-4">
                      <select
                        ...
                        value={formData.isAvailableForRent ? "true" : "false"}
                        onChange={handleRadioChange}
                        className="w-full border p-2"
                      >
                        <option value="true">Yes</option>
